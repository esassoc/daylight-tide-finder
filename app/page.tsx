...
export default function Home(){
  ...
  return <main id="top">
    ...
    <section className="method" id="how"><div><span>01</span><h3>Choose the work mode</h3><p>Find windows at or below a low-tide maximum, or at or above a high-tide minimum.</p></div><div><span>02</span><h3>Set the field criteria</h3><p>Choose a station, elevation datum, threshold, and the minimum continuous time your work requires.</p></div><div><span>03</span><h3>Inspect the window</h3><p>Review only windows long enough for the job, using buffered daylight or the 30° sun filter for working light.</p></div></section>
