...
async function loadStations():Promise<Station[]> {
  ...
  return (data.stations??[])
    ...
    .map(station=>({id:String(station.id),name:String(station.name),state:station.state as Station["state"],lat:Number(station.lat),lng:Number(station.lng),type:station.type==="S"?"S":"R"}))
...
export default function Home(){
  ...
  return <main id="top">
    <header className="site-header"><a className="brand" href="#top"><span className="wave-mark"><i/><i/><i/></span><span><b>Daylight Tide Finder</b><small>Pacific Coast field guide</small></span></a><nav><a href="#how">How it works</a><a href="https://tidesandcurrents.noaa.gov/" target="_blank" rel="noreferrer">NOAA data ↗</a></nav></header>
